...
class ProductAdmin(admin.ModelAdmin):
    ...
    search_fields = ['name', 'category__title', 'vendor__email', 'created_by__email']
    list_filter = ['status', 'featured', 'category', 'vendor', 'created_by']
...
class OrderAdmin(admin.ModelAdmin):
    ...
    list_editable = ['payment_status', 'status', 'payment_method']
    search_fields = ['order_id', 'customer__username', 'customer__email']
    list_filter = ['payment_status', 'status', 'status_changed_by']
